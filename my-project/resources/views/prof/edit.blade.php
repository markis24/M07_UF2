        ...
        <form action="{{ route('/prof/update'. $prof['id']) }}" method="post">
            ...
            <div class="form-group">
                ...
                <select name="rol" id="rol" class="form-control">
                    ...
                    <option value="professorat" {{ $prof['rol'] == 'professorat' ? 'selected' : '' }}>Professor</option>
                    <option value="administrador" {{ $prof['rol'] == 'administrador' ? 'selected' : '' }}>Administrador</option>
                </select>
            </div>
